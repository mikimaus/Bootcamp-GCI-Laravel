<div class="relative">
    <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl" nav-pills role="tablist">
      <li class="z-30 flex-auto text-center">
        <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-in-out bg-inherit text-slate-700" nav-link active href="javascript:;" role="tab" aria-selected="true">
      ...
      <li class="z-30 flex-auto text-center">
        <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-in-out bg-inherit text-slate-700" nav-link href="javascript:;" role="tab" aria-selected="false">
      ...
      <li class="z-30 flex-auto text-center">
        <a class="z-30 block w-full px-0 py-1 mb-0 transition-colors border-0 rounded-lg ease-in-out bg-inherit text-slate-700" nav-link href="javascript:;" role="tab" aria-selected="false">
